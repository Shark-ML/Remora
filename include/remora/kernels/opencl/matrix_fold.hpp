...
void matrix_fold(matrix_expression<MatA, opencl_tag> const& A_unreg, typename F::result_type& value, Orientation, dense_tag) {
	auto& queue = A_unreg().queue();
	typedef typename F::result_type value_type;
	opencl::detail::meta_kernel k("blas_matrix_fold");
